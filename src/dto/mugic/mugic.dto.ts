...
export const MUGIC_STATUS_EFFECT_TYPES = [
  "exhaust_disciplines",
  "prevent_movement",
  "prevent_heal",
  "prevent_energy_gain",
...
export const MUGIC_ACTION_TYPE_OPTIONS: Array<{
  ...
  label: string;
    ...
    { value: "cancel_target_attack", label: "Cancele um Ataque alvo" },
    ...
    { value: "redirect_target", label: "Redirecionar alvo" },
    { value: "relocate_target", label: "Realocar alvo" },
    { value: "banish_card_from_discard", label: "Banir carta do descarte" },
    ...
    { value: "grant_keyword", label: "Conceder palavra-chave" },
    { value: "remove_element_attack_bonus", label: "Remover tipos elementais" },
